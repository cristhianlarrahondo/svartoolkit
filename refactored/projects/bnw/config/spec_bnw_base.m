%SPEC_BNW_BASE  Campos comunes de configuracion — proyecto BNW (projects/bnw).
%
...
%   projects/bnw/) ANTES de incluir este archivo. Esto es necesario porque
...
if ~exist('ex_dir', 'var')
    error('spec_bnw_base:missingExDir', ...
        ['spec_bnw_base.m debe incluirse via eval(fileread(...)) desde un ' ...
         ...
         'variable ex_dir (ruta absoluta a projects/bnw/).']);
end
