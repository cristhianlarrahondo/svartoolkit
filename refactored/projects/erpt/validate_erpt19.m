...
%   (projects/erpt/src/), que ya era literalmente identico a este
%   local_run_spec (mismos defaults: quiet_cfg=false, compute_frac_top=
%   true) -- wiring de dedup puro, sin ningun cambio de comportamiento.
%   Reset determinista de RNG por spec preservado sin cambios dentro de
%   erpt_run_spec.m.
