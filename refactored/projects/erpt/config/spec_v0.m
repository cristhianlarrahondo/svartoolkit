%SPEC_V0  ERPT — Identificacion Opcion B (restricciones minimas, set-identified)
%
...
%     6. tib      — Interest Rate
%
%   Identificacion (3 shocks, 1 signo + 1 cero cada uno):
%     Shock 1 (Cam) : signo var1(+)        | cero var6
%     Shock 2 (Dem) : signo var5(+)        | cero var2
%     Shock 3 (Ofe) : signo var4(-)        | cero var2
%
%   Condicion de orden ARW: con 3 shocks se necesitan 0,1,2 ceros
%   (ordenando de mayor a menor). Aqui los tres shocks tienen 1 cero
%   cada uno -> el shock en la 3a posicion no alcanza el minimo de 2.
%   Resultado esperado: identificacion PARCIAL (set-identified) para
%   al menos un shock. Se usa como punto de comparacion contra spec_v1
%   (exactamente identificada), NO como error a corregir.
%
