%spec_A_rob_aa_diffuse_lag4_v0  ERPT Ejercicio A -- a/a, prior diffuse, lag 4, matriz rob
%
...
Cfg.SPEC_NAME = 'spec_A_rob_aa_diffuse_lag4_v0';
...
% -- Shock 4: Mon (libera pro_inf vs base) : con(-), ea(-), ir(+) --------
Cfg.S{4} = [ build_restriction_row(4, 1, n_vars, n_horizons, -1); ...
             build_restriction_row(5, 1, n_vars, n_horizons, -1); ...
             build_restriction_row(6, 1, n_vars, n_horizons,  1) ];
Cfg.Z{4} = [];
