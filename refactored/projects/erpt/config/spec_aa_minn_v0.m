%SPEC_AA_MINN_V0  ERPT baseline oficial — a/a, prior Minnesota, Opcion B
%
...
%   spec_aa_diffuse_v0.m; unica diferencia de esta variante es el prior):
...
%   Cfg.PRIOR.lambda3 = 1
%
%   Dummies COVID: IDENTICAS a spec_aa_diffuse_v0.m (mismas ventanas,
%   mismo dataset a/a — ver ese archivo o el .md de cierre de ERPT-Chat 3
